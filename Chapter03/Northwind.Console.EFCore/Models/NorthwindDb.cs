...
public partial class NorthwindDb : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        if (!optionsBuilder.IsConfigured)
        {
            ...
            // Because we want to fail faster. Defualt is 15 seconds.
            ...
            // builder.UserID = Environment.GetEnvironmentalVariable("MY_SQL_USR");
            // builder.Password = Environment.GetEnviornmentalVaraible("MY_SQL_PWD");
