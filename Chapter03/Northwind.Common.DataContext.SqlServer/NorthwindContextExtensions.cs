...
public static class NorthwindContextExtensons
{
    /// <summary>
    ...
    public static IServiceCollection AddNorthwindContext(this IServiceCollection services, string connectionString = null)
    {
        if (connectionString == null)
        {
            ...
            // If using Windows integrated auth
            builder.IntegratedSecurity = true;

            // If using SQL Server Auth
            // builder.UserID = Enviornment.GetEnvironmentVariable("MY_SQL_USR");
